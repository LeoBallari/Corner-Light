...
public class b4ximageview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Corner.Light.Bluetooth.b4ximageview");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Corner.Light.Bluetooth.b4ximageview.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("920119579","Invalid resize mode: "+_mresizemode,0);
 break; }
}
;
