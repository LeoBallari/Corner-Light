...
public class anotherprogressbar extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Corner.Light.Bluetooth.anotherprogressbar");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Corner.Light.Bluetooth.anotherprogressbar.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_BusyLoop(Corner.Light.Bluetooth.anotherprogressbar parent) {
this.parent = parent;
}
Corner.Light.Bluetooth.anotherprogressbar parent;
int _myindex = 0;
