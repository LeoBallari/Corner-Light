...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Corner.Light.Bluetooth.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Corner.Light.Bluetooth.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public Corner.Light.Bluetooth.b4xdialog _mdialog = null;
...
_mdialog = new Corner.Light.Bluetooth.b4xdialog();
...
public ResumableSub_Show(Corner.Light.Bluetooth.b4xdatetemplate parent,Corner.Light.Bluetooth.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
Corner.Light.Bluetooth.b4xdatetemplate parent;
