...
public class b4xcolortemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Corner.Light.Bluetooth.b4xcolortemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Corner.Light.Bluetooth.b4xcolortemplate.class).invoke(this, new Object[] {null});
        else
...
public Corner.Light.Bluetooth.b4xcolortemplate._colorpickerpart _huebar = null;
public Corner.Light.Bluetooth.b4xcolortemplate._colorpickerpart _colorpicker = null;
public Corner.Light.Bluetooth.b4xcolortemplate._colorpickerpart _alphabar = null;
public int _borderscolor = 0;
public Corner.Light.Bluetooth.b4xdialog _xdialog = null;
...
int _r = 0;
int _w = 0;
Corner.Light.Bluetooth.b4xcolortemplate._colorpickerpart _cpp = null;
int _i = 0;
...
_cpp = (Corner.Light.Bluetooth.b4xcolortemplate._colorpickerpart)(group12[index12]);
...
_huebar = new Corner.Light.Bluetooth.b4xcolortemplate._colorpickerpart();
_colorpicker = new Corner.Light.Bluetooth.b4xcolortemplate._colorpickerpart();
_alphabar = new Corner.Light.Bluetooth.b4xcolortemplate._colorpickerpart();
 //BA.debugLineNum = 12;BA.debugLine="Private BordersColor As Int";
_borderscolor = 0;
 //BA.debugLineNum = 13;BA.debugLine="Private xDialog As B4XDialog";
_xdialog = new Corner.Light.Bluetooth.b4xdialog();
...
public Corner.Light.Bluetooth.b4xcolortemplate._colorpickerpart  _createpanelforbitmapcreator(String _eventname,boolean _withcheckers) throws Exception{
Corner.Light.Bluetooth.b4xcolortemplate._colorpickerpart _cpp = null;
...
_cpp = new Corner.Light.Bluetooth.b4xcolortemplate._colorpickerpart();
...
public String  _drawcheckers(Corner.Light.Bluetooth.b4xcolortemplate._colorpickerpart _cpp) throws Exception{
int _size = 0;
int[] _clrs = null;
int _clr = 0;
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getpanel(Corner.Light.Bluetooth.b4xdialog _dialog) throws Exception{
...
public void  _show(Corner.Light.Bluetooth.b4xdialog _dialog) throws Exception{
ResumableSub_Show rsub = new ResumableSub_Show(this,_dialog);
rsub.resume(ba, null);
}
public static class ResumableSub_Show extends BA.ResumableSub {
public ResumableSub_Show(Corner.Light.Bluetooth.b4xcolortemplate parent,Corner.Light.Bluetooth.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
Corner.Light.Bluetooth.b4xcolortemplate parent;
Corner.Light.Bluetooth.b4xdialog _dialog;
...
if (BA.fastSubCompare(sub, "GETPANEL"))
	return _getpanel((Corner.Light.Bluetooth.b4xdialog) args[0]);
