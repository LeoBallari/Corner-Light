...
public class b4xinputtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Corner.Light.Bluetooth.b4xinputtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Corner.Light.Bluetooth.b4xinputtemplate.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_Show(Corner.Light.Bluetooth.b4xinputtemplate parent,Corner.Light.Bluetooth.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
Corner.Light.Bluetooth.b4xinputtemplate parent;
