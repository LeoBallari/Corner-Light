...
public class b4xdialog extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Corner.Light.Bluetooth.b4xdialog");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Corner.Light.Bluetooth.b4xdialog.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_Show(Corner.Light.Bluetooth.b4xdialog parent,Object _text,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
this._text = _text;
this._yes = _yes;
this._no = _no;
...
Corner.Light.Bluetooth.b4xdialog parent;
Object _text;
Object _yes;
Object _no;
Object _cancel;
...
public ResumableSub_ShowCustom(Corner.Light.Bluetooth.b4xdialog parent,anywheresoftware.b4a.objects.B4XViewWrapper _content,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
...
public ResumableSub_ShowTemplate(Corner.Light.Bluetooth.b4xdialog parent,Object _dialogtemplate,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
