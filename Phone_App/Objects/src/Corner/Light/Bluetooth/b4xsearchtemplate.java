...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Corner.Light.Bluetooth.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Corner.Light.Bluetooth.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public Corner.Light.Bluetooth.b4xfloattextfield _searchfield = null;
...
_searchfield = new Corner.Light.Bluetooth.b4xfloattextfield();
...
__c.LogImpl("925886751","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(Corner.Light.Bluetooth.b4xsearchtemplate parent,Corner.Light.Bluetooth.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
Corner.Light.Bluetooth.b4xsearchtemplate parent;
