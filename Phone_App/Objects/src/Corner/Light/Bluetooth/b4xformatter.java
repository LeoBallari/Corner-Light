...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Corner.Light.Bluetooth.b4xformatter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Corner.Light.Bluetooth.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public String  _addformatdata(Corner.Light.Bluetooth.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public Corner.Light.Bluetooth.b4xformatter._b4xformatdata  _copyformatdata(Corner.Light.Bluetooth.b4xformatter._b4xformatdata _data) throws Exception{
Corner.Light.Bluetooth.b4xformatter._b4xformatdata _d = null;
...
_d = new Corner.Light.Bluetooth.b4xformatter._b4xformatdata();
...
public Corner.Light.Bluetooth.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
Corner.Light.Bluetooth.b4xformatter._b4xformatdata _d = null;
...
Corner.Light.Bluetooth.b4xformatter._b4xformatdata _data = null;
...
public Corner.Light.Bluetooth.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (Corner.Light.Bluetooth.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 80;BA.debugLine="End Sub";
return null;
}
public Corner.Light.Bluetooth.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
Corner.Light.Bluetooth.b4xformatter._b4xformatdata _d = null;
...
_d = (Corner.Light.Bluetooth.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public Corner.Light.Bluetooth.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
